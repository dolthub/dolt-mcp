...
var testDoltFetchAllBranchesSetupSQL = DialectSQL{
...
var testDoltFetchAllBranchesTeardownSQL = DialectSQL{
...
SELECT dolt_branch('-D', 'fetchme2');
SELECT dolt_branch('-D', 'fetchme3');
`,
}
